...
<head>
    ...
    <title>Chat -  Nuevo Style - <?php echo  $_SESSION['rep_pel'] ?></title>
    ...
    <script src="../js/Process/Chat.js"></script>
                                    ...
                                    <ui class="contacts">
                                        ...
                                        if ($lista==null) {
                                            echo "<li>";
                                                    ...
                                                    echo "<span>No hay Contactos</span>";
                                            ...
                                            for ($i=0; $i < count($lista); $i++) { 
                                                $u = $lista[$i];
                                                    echo "<li>";
                                                    echo "<button onclick='showinfo(\"".$u->getId_Usuario()."\",\"".$u->getNombre()."\",\"".$u->getApellido()."\")' style='cursor: pointer; width: 100%; border: none; background: transparent;'>";
                                                    echo "<div class='d-flex bd-highlight'>";
                                                    echo "<div class='img_cont'>";
                                                    echo "<img src='../img/iconos/soporte.png' class='rounded-circle user_img'>";
                                                    ...
                                                    echo "</div>";
                                                    echo "<div class='user_info'>";
                                                    echo "<span>".$u->getNombre()." ".$u->getApellido()."</span>";
                                                    echo "</div>";
                                                    echo "</div>";
                                                    echo "</button>";
                                                    echo "</li>";
