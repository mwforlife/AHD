...
$template_file = "../templates/Support_Message.php";

// set the email 'from' information
$email_from = "Wilkens <ahd@wilkenstech.host>";

// create a list of the variables to be swapped in the html template
$swap_var = array(
    "{SITE_ADDR}" => "https://www.wilkenstech.host",
    "{EMAIL_LOGO}" => "https://wilkenstech.host/img/logo/logo.png",
    "{EMAIL_TITLE}" => "Soporte -AHD Hairdresser - Nuevo Style",
    "{CUSTOM_IMG}" => "",
    "{TO_NAME}" => $nombre,
    "{TO_EMAIL}" => $correo,
    "{MESSAGE}"=> $mensaje
